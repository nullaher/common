 ...
 * cn.nullah.common.validator.IDCValidator.java Administrator 2016年8月12日
 */
 ...
 */
public class IDCValidator implements ConstraintValidator<IDCNum , String>{
	
	@Override
	public void initialize(IDCNum constraintAnnotation){
	...
	private static String[] _areaCode = {"11" , "12" , "13" , "14" , "15" , "21" , "22" , "23" , "31" , "32" , "33" , "34" , "35" , "36" ,
		...
		// 2月的情况
			...
			if((year % 4 == 0 && year % 100 != 0) || (year % 400 == 0)){
				if(Integer.valueOf(dayCode) > 29 || Integer.valueOf(dayCode) < 1){
					_codeError = "错误：输入的身份证号" + (isEighteenCode ? "(13-14位)" : "(11-13位)") + "[" + dayCode + "]号在" + year
