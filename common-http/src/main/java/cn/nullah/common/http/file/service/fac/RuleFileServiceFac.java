 ...
 * cn.nullah.common.http.file.fac.RuleFileServiceFac.java zxy@nullah.cn 2017年7月27日
 */
 ...
 * @desc : ...
 */
public class RuleFileServiceFac implements IFileServiceFac {
	Logger logger = LoggerFactory.getLogger(getClass());
	
	private FileContext context;
	
	private RuleFileServiceFac(FileContext context){
		this.context = context;
	}
	
	public static IFileServiceFac build(FileContext context){
		return new RuleFileServiceFac(context);
	}
